...
const SearchCard = () => {
  ...
  <h1 className="text-2xl font-bold mb-4 text-[#C55939]">ค้นหา</h1>
  ...
  <input
    ...
    className="border border-[#e19c5d] rounded-lg w-full mb-4 px-3 py-2 
               focus:ring-2 focus:ring-[#edb394] focus:outline-none text-black"
  />

  <hr className="border-[#f1e3c7] mb-4" />

  <div>
    <h2 className="text-lg font-semibold mb-2 text-[#C55939]">หมวดหมู่</h2>
